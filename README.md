...
A Java console-based application that demonstrates **exception handling**, **multithreading**, **wrapper classes**, and **input validation**.
This implementation follows the exact requirements from the assignment document.
